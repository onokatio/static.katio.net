...
- 2017年〜 fressets株式会社（インフラAnsibleでAzureのサーバー作成自動化など）
...
- Rust（スタックマシンを実装する程度）
- Python（統計調査や機械学習に使用する程度）
- Javescript/es6 (フレームワークを使わないSPAを作る程度）
- React.js (状態を持たないコンポーネントを自作して描画する程度)
...
- さくらインターネット石狩DC見学2017年と2018年で2回
- 小山高専ネットワーク演習講座2017年3月
- 高知高専プロジェクト成果発表会2017年5月
- さくらインターネット東京オフィス・東京DC見学2017年9月
- NTTセキュリティジャパンSOC見学2017年
- LINE福岡本社見学2017年
...
- PwC株式会社サイバー演習2017年9月
- 石川高専情報セキュリティ高度人材育成春休み合宿講座2017年12月25-26日
...
- 高知高専情報セキュリティ教材に関するコンテンツ展示会CTFの展示・演習運営2017年5月
